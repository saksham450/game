...
class Leaderboard(object):
    def __init__(self, x, y):
        ...
        self.score_font = pygame.font.SysFont("comicsans", 20, bold=False)
        self.rank_font = pygame.font.SysFont("comicsans", 60, bold=False)
    ...
    def draw(self, win):
        ...
        for i, score in enumerate(scores):
            ...
            score_text = self.score_font.render("Score: " + str(score[1]), True, (0, 0, 0))
            win.blit(score_text, (self.x - name.get_width() / 2 + self.WIDTH / 2, self.y + i * self.HEIGHT_ENTRY + 40))
